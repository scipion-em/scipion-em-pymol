...
methodList = ['Systematic', 'Random', 'Weighted']


class ProtGlobalOptimizeStruct(ProtAnalysis3D):
    """Global conformation search using Pymol"""
    _label = 'optimize structure - global'
    ...
    def _defineParams(self, form):
        ...
        form.addParam('method', params.EnumParam,
                      choices=['Systematic', 'Random', 'Weighted'], default=2,
                      label='Minimization method',
                      help='The method used to find the local minimum. The methods available are:\n'
                           'Systematic: Systematically iterate through all possible conformers according '
                           'to Open Babel’s torsion library.\n'
                           'Random: Conformations are generated by randomly choosing from '
                           'the allowed torsion angles.\n'
                           'Weighted: This method uses an iterative procedure to find a global minimum.')
    ...
    def writeScript(self):
        ...
        contents = 'load %s, s1\n' \
                   ...
                   'plugins.initialize()\n' \
                   'from pmg_tk.startup.optimize import conf_search\n' \
                   'conf_search(selection="s1",forcefield="%s",method="%s",nsteps1=%d, lowest_conf=1)\n' \
                   'save %s, s100' % \
